...
S {}
E {}
C {code_shown.sym} 310 730 0 0 {name=s1 only_toplevel=false value=".include /home/u5552_bharadw/cloudv/sensor/repo/try1.spice
.lib /ef/tech/SW.2/sky130A/libs.tech/ngspice/sky130.lib.spice hh
.option temp=27
.tran 1n 500u
.save vctrl vout
.options trtol=1 chgtol=1e-16
.control
run 
set color0 = white
set color1 = black
